...
<head>
    ...
    <title>Login || Democratizecore</title>
            ...
            <div class="container-xxl flex-grow-1 p-3">
                <nav class="navbar navbar-example navbar-expand-lg bg-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="javascript:void(0)">Democratizecore.</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbar-ex-3">
                            ...
                            <form id="navigationForm">
                                <button class="btn btn-primary" type="button" onclick="navigateTo('usuario-invitado')">Realizar Voto</button>
